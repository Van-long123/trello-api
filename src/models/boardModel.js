...
const BOARD_COLLECTION_SCHEMA = Joi.object({
  ...
  labels: Joi.array().items({
    ...
    { 'id': 'lbl1', 'color': '#b6f9d0', 'name': 'Mint Green' },
    { 'id': 'lbl2', 'color': '#f5f18c', 'name': 'Soft Yellow' },
    { 'id': 'lbl3', 'color': '#ffe3a3', 'name': 'Light Yellow' },
    { 'id': 'lbl4', 'color': '#ffcfcf', 'name': 'Peach Pink' },
    { 'id': 'lbl5', 'color': '#e5c8fa', 'name': 'Lavender' },

    { 'id': 'lbl6', 'color': '#4dd4a2', 'name': 'Emerald Green' },
    { 'id': 'lbl7', 'color': '#f5cf45', 'name': 'Golden Yellow' },
    { 'id': 'lbl8', 'color': '#ffa62b', 'name': 'Orange' },
    { 'id': 'lbl9', 'color': '#ff6b6b', 'name': 'Red' },
    { 'id': 'lbl10', 'color': '#c77dff', 'name': 'Purple' },

    { 'id': 'lbl11', 'color': '#1b998b', 'name': 'Teal' },
    { 'id': 'lbl12', 'color': '#a1662f', 'name': 'Brown' },
    { 'id': 'lbl13', 'color': '#c44536', 'name': 'Brick Red' },
    { 'id': 'lbl14', 'color': '#ff4d4d', 'name': 'Bright Red' },
    { 'id': 'lbl15', 'color': '#9d4edd', 'name': 'Violet' },

    { 'id': 'lbl16', 'color': '#d0e7ff', 'name': 'Baby Blue' },
    { 'id': 'lbl17', 'color': '#aee1f9', 'name': 'Sky Blue' },
    { 'id': 'lbl18', 'color': '#c6f6d5', 'name': 'Light Green' },
    { 'id': 'lbl19', 'color': '#ffc6f7', 'name': 'Pink' },
    { 'id': 'lbl20', 'color': '#d9d9d9', 'name': 'Gray' },

    { 'id': 'lbl21', 'color': '#7ebaff', 'name': 'Blue' },
    { 'id': 'lbl22', 'color': '#56ccf2', 'name': 'Cyan' },
    { 'id': 'lbl23', 'color': '#84d95a', 'name': 'Green' },
    { 'id': 'lbl24', 'color': '#ff70a6', 'name': 'Magenta Pink' },
    { 'id': 'lbl25', 'color': '#8f8f8f', 'name': 'Dark Gray' },

    { 'id': 'lbl26', 'color': '#006eff', 'name': 'Bright Blue' },
    { 'id': 'lbl27', 'color': '#0077b6', 'name': 'Deep Blue' },
    { 'id': 'lbl28', 'color': '#57cc99', 'name': 'Sea Green' },
    { 'id': 'lbl29', 'color': '#d83367', 'name': 'Rose Red' },
    { 'id': 'lbl30', 'color': '#555555', 'name': 'Charcoal' },

    { 'id': 'lbl31', 'color': '#003f91', 'name': 'Navy Blue' },
    { 'id': 'lbl32', 'color': '#005f73', 'name': 'Teal Blue' },
    { 'id': 'lbl33', 'color': '#386641', 'name': 'Forest Green' },
    { 'id': 'lbl34', 'color': '#9b2226', 'name': 'Dark Red' },
    { 'id': 'lbl35', 'color': '#343a40', 'name': 'Dark Gray Black' },

    { 'id': 'lbl36', 'color': '#0d1b2a', 'name': 'Midnight Blue' },
    { 'id': 'lbl37', 'color': '#1b263b', 'name': 'Dark Navy' },
    { 'id': 'lbl38', 'color': '#2d6a4f', 'name': 'Pine Green' },
    { 'id': 'lbl39', 'color': '#720026', 'name': 'Wine Red' },
